...
export const Nav: React.FC<NavProps> = ({ className }) => {
  ...
  return (
    <header className={`w-full bg-white h-20 flex justify-between items-center px-5 ${className ? className : ''}`}>
      <Image
